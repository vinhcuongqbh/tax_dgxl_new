...
@section('title', 'Dự kiến kết quả xếp loại năm của cá nhân')
                        ...
                        <table id="table" class="table table-bordered table-striped">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center align-middle">KQXL Quý 1</th>
                                    <th class="text-center align-middle">KQXL Quý 2</th>
                                    <th class="text-center align-middle">KQXL Quý 3</th>
                                    <th class="text-center align-middle">KQXL Quý 4</th>
                                    <th class="text-center align-middle">KQXL tập thể phòng/đội</th>
                                    <th class="text-center align-middle">Dự kiến KQXL năm</th>
                                </tr>
                            </thead>
                            <tbody>
                                @php $i = 1 @endphp
                                @foreach ($don_vi as $dv)
                                    @if ($phieu_danh_gia->where('ma_don_vi', $dv->ma_don_vi)->count() > 0)
                                        <tr>
                                            ...
                                            <td class="text-bold bg-olive" colspan="9">{{ $dv->ten_don_vi }}</td>
                                    ...
                                    @foreach ($phong->where('ma_don_vi_cap_tren', $dv->ma_don_vi) as $ph)
                                        @if ($phieu_danh_gia->where('ma_phong', $ph->ma_phong)->count() > 0)
                                            <tr>
                                                ...
                                                <td class="text-bold" colspan="9">{{ $ph->ten_phong }}</td>
                                                <td style="display: none;"></td>
                                                <td style="display: none;"></td>
                                                <td style="display: none;"></td>
                                                <td style="display: none;"></td>
                                        ...
                                        @foreach ($phieu_danh_gia->where('ma_phong', $ph->ma_phong) as $phieu)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $phieu['kqxl_q1'] }}</td>
                                                <td class="text-center">{{ $phieu['kqxl_q2'] }}</td>
                                                <td class="text-center">{{ $phieu['kqxl_q3'] }}</td>
                                                <td class="text-center">{{ $phieu['kqxl_q4'] }}</td>
                                                <td class="text-center"></td>
                                                <td class="text-center text-bold">{{ $phieu['kqxl_nam'] }}</td>
                                            </tr>
                                        @endforeach
                                    @endforeach
                                @endforeach
