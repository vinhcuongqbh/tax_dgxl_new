            ...
            <div class="col-12">
                <div class="card card-default">
                    <div class="card-body">
                                        ...
                                        @if ($ket_qua->loai_tieu_chi != 'phuong_an')
                                            <td class="align-middle @if ($tinh_diem == 0) text-bold @endif">
                                                <input type="number" id="{{ $ket_qua->ma_tieu_chi }}"
                                                    ...
                                                    readonly @if ($tinh_diem == 0) readonly @endif>
                                            </td>
                                        @else
                                            {{-- Ghi chú: 
                        ...
                        <table id="tong_hop" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-bold">
                                        <input type="number" id="diem_thuc_hien_nhiem_vu" name="diem_thuc_hien_nhiem_vu"
                                            value="{{ $phieu_danh_gia->diem_thuc_hien_nhiem_vu }}"
                                            class="text-center form-control pl-4" min="0" max="70"
                                            step="0.5" onchange="tong_cong(); tu_xep_loai();" readonly>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                        ...
                        <h6>4. Ưu điểm:</h6>
                        <textarea id="uu_diem" name="uu_diem" rows="5" style="width: 100%;" readonly>{{ $phieu_danh_gia->uu_diem }}</textarea>
                        <br>

                        <h6>5. Hạn chế, khuyết điểm:</h6>
                        <textarea id="khuyet_diem" name="khuyet_diem" rows="5" style="width: 100%;" readonly>{{ $phieu_danh_gia->khuyet_diem }}</textarea>
                        <br>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    {{-- Xếp loại C --}}
                                    <td class="text-center">
                                        <input type="radio" name="ca_nhan_tu_xep_loai" value="C" id="hoan_thanh"
                                            class="form-control">
