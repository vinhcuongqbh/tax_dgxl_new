...
@section('heading')
    <form action="{{ route('phieudanhgia.hoidong.tonghopdukienquy') }}" method="post">
        @csrf
        <div class="d-flex">
            <div class="col-8">
            ...
            <div class="d-flex justify-content-end col-4">
                ...
                <input id="quy_danh_gia" name="quy_danh_gia" type="number" min="1" max="4"
                    value="{{ $quy_danh_gia }}" class="form-control col-3 text-center"><label
                    class="h6 mt-2 mx-2">/</label><input type="number" id="nam_danh_gia" name="nam_danh_gia"
...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <form action="{{ route('phieudanhgia.hoidong.pheduyetquy') }}" method="post" id="formSubmit">
                    @csrf
